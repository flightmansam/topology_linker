...
water_balance("WARBURN", '26025', '40949', "../out/WARBURN_LINKED.csv", period_start, period_end, use_regs=True, show=False)
...
period_end = pd.datetime(year=2019, month=12, day=17, hour=00)
water_balance("WARBURN", '26025', '40949', "../out/WARBURN_LINKED.csv", period_start, period_end, use_regs=True, show=False)
