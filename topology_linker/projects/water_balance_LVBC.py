...
period_start = pd.datetime(year=2020, month=2, day=16, hour=00)
period_end = pd.datetime(year=2020, month=3, day=17, hour=00)

water_balance("LVBC", '29355', '65041', "../out/LINKED.csv", period_start, period_end, area=272747.0, use_regs=False, show=False, debug=False)
