...
for csv in csvs:
    ...
    # outlets.columns = ["Outlet", "RTU_totaliser", "Manual_reading"]
    ...
    # for o in outlets.outlet:
    #     o = outlets.loc[outlets.outlet == o]
    #     for tagd in ["RTU_totaliser", "Flow_integral", "Manual_reading"]:
    #         ev = o[tagd].values[0]
    #         tagi = tags.loc[(tags.OBJECT_NO == o.outlet) & (tags.TAG_DESC == tagd), "TAG_ID"].values[0]
...
spreadsheet :pd.DataFrame = pd.concat(spreadsheet).sort_index()
